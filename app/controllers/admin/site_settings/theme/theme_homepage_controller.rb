...
module Admin::SiteSettings::Theme
  class ThemeHomepageController < ThemeController
    ...
    def show
      add_to_actions(
        ...
        class: "primary",
        icon: "edit",
        url: edit_admin_settings_theme_homepage_path,
    ...
    private
      ...
      def load_entry
        @entry = SiteSettings::Theme::Homepage.instance
      end

      def entry_params
        allowed_attrs = set_allowed_attrs
        params.require(:site_settings_theme_homepage).permit(*allowed_attrs)
      end
