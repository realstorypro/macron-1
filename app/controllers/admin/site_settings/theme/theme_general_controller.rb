...
module Admin::SiteSettings::Theme
  class ThemeGeneralController < ThemeController
    ...
    def show
      add_to_actions(
        ...
        class: "primary",
        icon: "edit",
        url: edit_admin_settings_theme_general_path,
