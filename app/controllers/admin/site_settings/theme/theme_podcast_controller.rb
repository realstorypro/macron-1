...
module Admin::SiteSettings::Theme
  class ThemePodcastController < ThemeController
    ...
    def show
      ...
      add_to_actions(
        ...
        class: "primary",
        icon: "edit",
        url: edit_admin_settings_theme_podcast_path,
