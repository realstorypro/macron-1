...
module Admin::SiteSettings::Theme
  class ThemeArticleController < ThemeController
    ...
    def show
      add_to_actions(
          ...
          class: "primary",
          icon: "edit",
          url: edit_admin_settings_theme_article_path,
