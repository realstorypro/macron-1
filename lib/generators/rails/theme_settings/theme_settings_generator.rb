...
class Rails::ThemeSettingsGenerator < Rails::Generators::NamedBase
  ...
  def copy_theme_settings_file
    ...
    copy_file "controller.rb",
              "app/controllers/admin/site_settings/theme/theme_#{file_name}_controller.rb"

    gsub_file "app/controllers/admin/site_settings/theme/theme_#{file_name}_controller.rb",
